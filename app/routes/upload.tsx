...
import { prepareInstructions } from '~/entities/home/consts';
import FileUploader from '~/features/home/ui/FileUploader';
import Navbar from '~/features/home/ui/Navbar';
import { generateUUID } from '~/shared/libs/id';
import { convertPdfToImage } from '~/shared/libs/pdf';
    ...
    const feedbackText =
      typeof feedback?.message?.content === 'string'
        ...
        : Array.isArray(feedback.message.content)
          ? feedback.message.content.at(0)?.text
          : '';
